...
class AppNavigation extends StatefulWidget {
  ...
  /// Count of installed extensions with a newer version available (Browse tab).
  final int browseBadge;
                        ...
                        children: [
                          Stack(
                            ...
                            children: [
                              ...
                              if (index == 2 && widget.browseBadge > 0)
                                Positioned(right: -6, top: -4,
                                  child: Container(
                                    padding: const EdgeInsets.symmetric(horizontal: 4, vertical: 1),
                                    decoration: BoxDecoration(
                                      ...
                                      borderRadius: BorderRadius.circular(8)),
                                    child: Text(
                                      widget.browseBadge > 99 ? '99+' : '${widget.browseBadge}',
                                      style: GoogleFonts.manrope(fontSize: 8, fontWeight: FontWeight.w800, color: Colors.white)),
                                  ),
                                ),
                            ],
