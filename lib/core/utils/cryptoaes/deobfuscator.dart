/// Deobfuscates JSFuck-style obfuscated password strings used by some sources.
/// Ported verbatim from Mangayomi.
class Deobfuscator {
  static String deobfuscateJsPassword(String inputString) {
    ...
    while (idx < inputString.length) {
      ...
      if (chr == '[') {
        ...
        if (closingIndex + 1 < inputString.length &&
            inputString[closingIndex + 1] == '[') {
          final skippingIndex =
